...
*-# 善用官方演示程序的“开发者模式”。这有助于加深对每个API接口的功能和应用的理解
...
*
*@section 当前API
* @version Version 2.21.39.1123(build: Dec  5 2019 11:59:48)
*
*
*@section 文档发布记录
...
dvp2api dvpStatus dvpSetConfigString(dvpHandle handle,const char *enable,const char *status);
